...
import ok.apps.newsapi.model.response.ArticleResponse;
import ok.apps.newsapi.model.response.DataResponse;
import ok.apps.newsapi.model.response.ErrorResponse;
import ok.apps.newsapi.model.response.SourceResponse;
